  ...
  <?php if (get_option('woocommerce_review_rating_verification_required') === 'no' || wc_customer_bought_product('', get_current_user_id(), $product->get_id())) : ?>
    <div id="review_form_wrapper">
      <div id="review_form">
        ...
        $fields              = array(
          'author' => array(
            'label'    => __('Name*', 'forzarent'),
            'type'     => 'text',
            'value'    => $commenter['comment_author'],
            'required' => $name_email_required,
          ),
          'email'  => array(
            'label'    => __('Email* (will not be published)', 'forzarent'),
            'type'     => 'email',
        ...
        $comment_form['comment_field'] .= '<p class="comment-form-comment"><textarea id="comment" class="form-control" placeholder="' . __('Your review...*', 'forzarent') . '" name="comment" cols="45" rows="8" required></textarea></p>';
