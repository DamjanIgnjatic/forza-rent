...
<?php if (is_user_logged_in()) { ?>
  ...
  <div class="account-salution">
    <p class="h2">
      <?php esc_html_e('Hello', 'forzarent'); ?> <?php global $current_user;
                                                  wp_get_current_user();
                                                  echo '' . $current_user->display_name . "\n";
                                                  ?>
    </p>
    <p><?php esc_html_e('Here you can view your recent orders, manage your shipping and billing addresses, and edit your password and account details.', 'forzarent'); ?></p>
  </div>
