...
Replace all of the "ForzaRent" string with your websites name and the "forzarent" string with your lowercased websites name without any whitespace (fore example instead of the string "The Theme" use "thetheme").
