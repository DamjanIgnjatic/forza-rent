            ...
            <div class="testimonials-section-wrapper--box-items">
                ...
                ?>
                    <?php if (count($testimonials) > 1) :
                        $description = $last_event['testimonial_description'];
                        $full_name = $last_event['first_and_last_name'];
                        $company = $last_event['user_company'];
                    ?>
                        <div class="testimonial cloned-slide">
                            <div>
                    ...
                    ?>
                        ...
                        <div class="testimonial <?php echo count($testimonials) === 1 ? "active" : "" ?>">
                            <div>
                                <svg xmlns=" http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" height="24px" width="24px" version="1.1" id="_x32_" viewBox="0 0 512 512" xml:space="preserve">
                                    <style type="text/css">
                                        .st0 {
                    ...
                    <?php if (count($testimonials) > 1) :
                        $description = $first_event['testimonial_description'];
                        $full_name = $first_event['first_and_last_name'];
                        $company = $first_event['user_company'];
                    ?>
                        <div class="testimonial cloned-slide">
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" height="24px" width="24px" version="1.1" id="_x32_" viewBox="0 0 512 512" xml:space="preserve">
