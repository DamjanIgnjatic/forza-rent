...
class CustomAdminLogin
{
    ...
    public function __construct()
    {
        ...
        $this->fields = [
            'login' => [
                'title' => __('Custom admin login URL', 'forzarent'),
                'description' => __('Set a custom admin login URL to protect your login page', 'forzarent'),
                'slug' => 'aeva'
            ],
            'redirect' => [
                'title' => __('Custom admin redirect URL', 'forzarent'),
                'description' => __('Set a custom admin 404 redirect URL if someone tryes to access wp-admin', 'forzarent'),
                'slug' => '404'
            ]
        ];
    ...
    {
        echo '<p>' . __('Set a custom admin login and 404 redirect URL to protect your login page.', 'forzarent') . '</p>';
    }
