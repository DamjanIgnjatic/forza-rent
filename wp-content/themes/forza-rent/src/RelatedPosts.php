...
?>
    ...
    {
        return '<h4 class="h2">' . __('Related', 'forzarent') . ': <a class="post-title" href="' . get_permalink() . '" alt="' . get_the_title() . '">' . get_the_title() . '</a>';
    }
    ...
    function relatedPosts($pid, $count = 3)
    {
        ...
        ?>
                <div class="related-posts-container">
                    <h2 class="h2"><?php _e('Related posts', 'forzarent'); ?></h2>
