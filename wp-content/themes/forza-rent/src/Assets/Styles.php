...
class Styles
{
    ...
    public function addStyles()
    {
        if (function_exists('wp_register_style') && function_exists('wp_enqueue_style') && function_exists('get_template_directory_uri')) {
            \wp_register_style('forzarent-theme-style', \get_template_directory_uri() . '/dist/css/theme.css', [], ASSETS_VERSION, 'all');
            \wp_enqueue_style('forzarent-theme-style');

            // Preload the hero section style
            $heroStyle = \get_template_directory_uri() . '/dist/css/theme-hero.css';
            \wp_register_style('preload-forzarent-theme-hero', $heroStyle, [], ASSETS_VERSION, 'all');
            \wp_enqueue_style('preload-forzarent-theme-hero');
            \wp_register_style('forzarent-theme-hero', $heroStyle, [], ASSETS_VERSION, 'all');
            \wp_enqueue_style('forzarent-theme-hero');
        }
    }
