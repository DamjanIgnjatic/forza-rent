...
class Scripts
{
    ...
    public function addScripts()
    {
        if (function_exists('wp_register_script') && function_exists('wp_enqueue_script') && function_exists('get_template_directory_uri')) {
            // Default scripts
            \wp_register_script('forzarent-theme', \get_template_directory_uri() . '/dist/js/theme.js', [], ASSETS_VERSION);
            \wp_enqueue_script('forzarent-theme');

            // Theme switcher
            \wp_register_script('forzarent-theme-switcher', \get_template_directory_uri() . '/dist/js/theme-switcher.js', [], ASSETS_VERSION);
            \wp_enqueue_script('forzarent-theme-switcher');
