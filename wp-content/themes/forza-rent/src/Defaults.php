...
class Defaults
{
    ...
    public function themeSetup()
    {
        if (function_exists('add_action')) {
            ...
            load_theme_textdomain('forzarent', get_template_directory() . '/languages');
            ...
            register_nav_menus([
                'header-menu' => esc_html__('Primary', 'forzarent'),
            ]);
    ...
    function themeDependencies()
    {
        if (!function_exists('get_field')) {
            echo '<div class="error"><p>' . __('Warning: The theme needs the Custom Fields pro plugin to function', 'forzarent') . '</p></div>';
        }
    }
